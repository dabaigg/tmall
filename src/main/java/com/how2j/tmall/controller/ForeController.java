...
public class ForeController {
    ...
    public String product(int pid,Model model){
        ...
        List<ProductImage> produstSingleImages = productImageService.list(product.getId(), ProductImageService.type_single);
        List<ProductImage> produstDetaileImages = productImageService.list(product.getId(), ProductImageService.type_deatil);
        product.setProductSingleImages(produstSingleImages);
        product.setProductDetailImages(produstDetaileImages);

        List<PropertyValue> pv = propertyValueService.list(product.getId());
        Review r = reviewService.get(product.getId());
